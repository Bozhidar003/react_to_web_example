...
`;
  const HelloWorld = ({ label = "Hello", name = "World", value = "{}" }) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(React.Fragment, { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hello-world-container", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "hello-world-button", onClick: handleClick, children: "Click Me" }),
        ...
        parsedValue && parsedValue.message && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "Additional info: ",
          parsedValue.message
        ] })
      ] })
  ...
  console.log("reactToWebComponent:", w);
  console.log("HelloWorld:", HelloWorld);
  const HelloWorldWebComponent = w(HelloWorld, React, ReactDOM, {
    shadow: true,
    props: ["label", "name", "value"]
  });
  customElements.define("hello-world-component", HelloWorldWebComponent);
});
//# sourceMappingURL=hello-world-web-component.umd.js.map
